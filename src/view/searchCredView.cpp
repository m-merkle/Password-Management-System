...
searchCredView::searchCredView(Database& db, passMang::Role userRole) : db(db), userRole(userRole)
{
    CredentialForm();
	...
	auto credBox = std::make_unique<Wt::WGroupBox>("All Credentials for All Users");
    	// get all credentials
